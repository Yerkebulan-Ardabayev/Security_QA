...
- [ ] 9 разделов, 250 ± 10 вопросов, у каждого непустой `sources`.
  ...
  - [ ] 08 Сценарии (~15)
  - [ ] 09 Soft skills (~10)
- [ ] Все ссылки из `sources` отвечают 200 (`node scripts/check-links.mjs`). Сейчас 332 из 332 (326 по коду 200, 6 вручную в браузере, список в `scripts/browser-verified.json`).
